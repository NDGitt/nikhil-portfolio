                  ...
                  <div className="pt-2">
                    ...
                    <div className="flex items-center space-x-3 mt-4">
                      ...
                      <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-4 py-1.5 bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-lg hover:from-gray-900 hover:to-black transition-all text-sm font-medium shadow-sm flex items-center gap-1.5"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      >
...
function App() {
  ...
  useEffect(() => {
    const checkMobile = () => {
      setIsMobile(window.innerWidth <= 768);  // Increased to 768px to support larger phones
    };
